...
//using namespace std;
//
//const int ARGUMENTS_EXPECTED = 3;   // command line args expected
//const int INFILE_ARG_IX = 1;        // index of input file name
//const int BYTE_COUNT_ARG_IX = 2;    // index of line count
//
